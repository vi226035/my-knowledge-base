...
> 概念性的深度学习问题（为什么需要激活函数、反向传播怎么算等）见 [深度学习/一些疑惑解答](../深度学习/一些疑惑解答.md)。
...
> 详细解释见 [深度学习/一些疑惑解答](../深度学习/一些疑惑解答.md)。
...
需要继续深入的概念（反向传播数学、激活函数原理、LSTM 机制等）见 [深度学习/一些疑惑解答](../深度学习/一些疑惑解答.md)。
